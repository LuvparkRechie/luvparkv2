              ...
              Expanded(
                child: ListView(
                  ...
                  children: <Widget>[
                    ...
                    ListTile(
                      leading:
                          const Icon(Icons.person, color: Color(0xFF1C1C1E)),
                    ...
                    ListTile(
                      leading:
                          const Icon(Icons.wallet, color: Color(0xFF1C1C1E)),
                      title: const CustomTitle(
                        text: "Wallet",
                        fontSize: 14,
                        fontStyle: FontStyle.normal,
                    ...
                    ListTile(
                      leading:
                          const Icon(Iconsax.car5, color: Color(0xFF1C1C1E)),
                      title: const CustomTitle(
                        text: "About Us",
                        fontSize: 14,
                        fontStyle: FontStyle.normal,
                ...
                child: GestureDetector(
                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        const CustomTitle(
                          text: "Verify and Update your Account",
                          fontSize: 18,
